...
#define GET_MATERIAL_FOR_DRAW \
  SIGNATURE("48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 49 8B 41")

#define DRAW_ARRAY_EXT SIGNATURE("48 8B C4 48 89 50 10 55 41 54")

#define EMIT_FOOTSTEP_SOUND SIGNATURE("48 8B C4 4C 89 40 ? 48 89 48 ? 56")
