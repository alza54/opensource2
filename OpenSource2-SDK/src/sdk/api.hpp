...
#define GET_PLAYER_CONTROLLER \
  SIGNATURE("40 53 48 83 EC ? 48 8B 05 ? ? ? ? 48 85 C0 74 3D")

#define GET_PLAYER_PAWN SIGNATURE("E8 ? ? ? ? 48 8B 88 ? ? ? ? 48 8B 01 FF 90 ? ? ? ? 48 8B C8")

#define GET_ENTITY_INDEX SIGNATURE("E8 ? ? ? ? 48 8B D8 48 85 C0 0F 84 ? ? ? ? 48 8B 10 48 8B C8 FF 92 ? ? ? ? 84 C0 0F 84 ? ? ? ? 48 3B F3")
